...
// 3. filter changed
#[system(RenderList)]
pub fn run (filter:Unique<&'a Filter>, item_labels:&ItemLabel, item_completes:&ItemComplete) {
    /*
    if item_labels.inserted().iter().next().is_some() 
        //|| item_labels.removed().iter().next().is_some() 
        || item_completes.modified().iter().next().is_some() {
        // TODO: || filter is dirty!
...
pub fn run (item_completes:&ItemComplete) {
    //TODO
    /*
...
#[system(RenderFilter)]
pub fn run (filter:Unique<&'a Filter>) {
    //TODO
    /*
    if dirty_filter.0 {
...
pub fn run (item_labels:&ItemLabel, item_completes:&ItemComplete) {
    //TODO
    /*
